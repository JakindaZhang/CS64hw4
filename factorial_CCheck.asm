...
# Call ConventionCheck here
    jal ConventionCheck
# I first directly use $a0 to do the calculatiion, but it doesn't give me the correct output
# so I use chatGPT help me to debug here, I found that ConventionCheck will modify what
# in $a0, so use $s0 instead
